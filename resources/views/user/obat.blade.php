...
<body>
    ...
    <div class="header">
        <i class="fa-solid fa-arrow-left" id="backIcon" style="cursor:pointer;" onclick="window.location='/etalaseobat'"></i>
        <h1>{{ $categoryName }}</h1>
        <div class="ikonKanan">
                ...
                @for($i = 0; $i < 12; $i++)
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="rating"><i class="fa-solid fa-star"></i> {{ $obat['rating'] ?? 'N/A' }} I Stok : {{ $obat['stock'] ?? '0' }}</p>
                        </div>
                    </div>
                @endfor
            </div>
